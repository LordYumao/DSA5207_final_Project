...
#             # print(f'labels before poincare_model.compute_metrics :{labels}')
...
class HypBert(nn.Module):
    ...
    def forward(
        ...
        return {'total_loss': loss, 'CE_loss': CE_loss, 'poincare_loss': poincare_loss, 'poincare_dist': poincare_dist, 'logits': logits, 'cls': cls, 'gamma':self.gamma.item(), 'alpha':self.alpha.item()}